...
func _determine_ending() -> void:
	...
	elif (not GameEventsState.resistance_path_level_3) and (not GameEventsState.resistance_path_level_4) and GameEventsState.helped_boss_level_2 and GameEventsState.helped_boss_level_3:
		_documents.append(load("res://scenes/documents/endings/administration_ending.tres"))
	else:
